...
import { ClipboardCheck, FileCheck, Search, Plus, Calendar, AlertTriangle, Check, X, ShieldCheck, Clock, User, ChevronRight, Download, Camera, Image as ImageIcon } from 'lucide-react';
        ...
        {isScheduling ? (
          ...
          <div className="flex-1 flex flex-col h-full overflow-hidden">
            ...
            <div className="mb-4 flex flex-wrap gap-2">
              ...
              {(selectedInspection.inspectionStatus === 'pending_rectification' || selectedInspection.inspectionStatus === 'closed' || selectedInspection.inspectionStatus === 'issued' || selectedInspection.status === 'completed') && (
                <button 
                  onClick={handleDownloadReport}
                  className="bg-slate-700 hover:bg-slate-600 text-white px-3 py-1.5 rounded-lg text-xs font-medium flex items-center gap-1.5 shadow-lg ml-auto"
                >
